        ...
        {loading ? (
          ...
          <>
            ...
            {isUnavailable && services.length > 0 && (
              <div className="mb-5 rounded-[14px] border border-amber-200 bg-amber-50 px-5 py-3 flex items-center gap-3">
              ...
              <div className="grid gap-4 sm:grid-cols-2">
                {services.map((svc) =>
                  isUnavailable ? (
                    <div
                      key={svc.id}
                      className="flex overflow-hidden rounded-[18px] border border-slate-200 bg-white opacity-60 cursor-not-allowed"
                    >
