...
export class AdminController {
  constructor(private readonly _service: IAdminService) {}

  async getDashboardStats(req: Request, res: Response, next: NextFunction) {
    try {
      const stats = await this._service.getDashboardStats();
  ...
  async getApplications(req: Request, res: Response, next: NextFunction) {
    try {
      ...
      const applications = await this._service.viewApplications(status);
  ...
  async getUsers(req: Request, res: Response, next: NextFunction) {
    try {
      ...
      const users = await this._service.viewUsers(search, status);
  ...
  async blockUser(req: Request, res: Response, next: NextFunction) {
    try {
      const user = await this._service.blockUser(req.params.id as string);
  ...
  async unblockUser(req: Request, res: Response, next: NextFunction) {
    try {
      const user = await this._service.unblockUser(req.params.id as string);
  ...
  async blockProvider(req: Request, res: Response, next: NextFunction) {
    try {
      const provider = await this._service.blockProvider(req.params.id as string);
  ...
  async unblockProvider(req: Request, res: Response, next: NextFunction) {
    try {
      const provider = await this._service.unblockProvider(req.params.id as string);
  ...
  async approveProvider(req: Request, res: Response, next: NextFunction) {
    try {
      const application = await this._service.approveProvider(req.params.id as string);
  ...
  async rejectProvider(req: Request, res: Response, next: NextFunction) {
    try {
      ...
      const application = await this._service.rejectProvider(req.params.id as string, reasonCode, adminRemarks);
  ...
  async getProviders(req: Request, res: Response, next: NextFunction) {
    try {
      const { search, status } = adminQuerySchema.parse(req.query);
      const providers = await this._service.viewProviders(search, status);
